...
const productData = {
  turmeric: {
    ...
    description:
      "Our premium organic turmeric powder is ethically sourced from tribal farmers in the Western Ghats. Known for its high curcumin content and vibrant color, this turmeric powder adds authentic flavor and health benefits to your dishes.",
    ...
    process: [
      {
        title: "Harvesting",
        description:
          "Hand-harvested by tribal farmers using traditional techniques that preserve the quality of the rhizomes.",
        image:
      ...
      },
      {
        title: "Processing",
        description:
          "Carefully washed, boiled, and sun-dried before being ground into fine powder using cold-grinding technology.",
        image:
      ...
      },
      {
        ...
        description:
          "Each batch undergoes rigorous testing for curcumin content, purity, and compliance with international standards.",
        image:
      ...
      },
      {
        title: "Packaging",
        description:
          "Packed in export-grade, airtight packaging that preserves freshness and extends shelf life.",
        image:
  ...
  pepper: {
    name: "Black Pepper",
    image:
      "https://images.unsplash.com/photo-1599678542742-0ad7ff68f7c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    description:
      "Our premium black pepper is sourced directly from small-scale farmers in Kerala. Known for its bold aroma and distinctive flavor, this pepper adds depth and character to any dish or product formulation.",
    origin: "Kerala, India",
    specs: [
    ...
    process: [
      {
        title: "Harvesting",
        description:
          "Carefully harvested at peak ripeness to ensure maximum flavor and quality.",
        image:
      ...
      },
      {
        title: "Processing",
        description:
          "Traditional sun-drying process to preserve natural oils and flavor compounds.",
        image:
      ...
      },
      {
        title: "Quality Testing",
        description:
          "Rigorous testing for piperine content, moisture levels, and microbial analysis.",
        image:
          "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Packaging",
        description:
          "Vacuum-sealed packaging to maintain freshness and aromatic properties.",
        image:
          "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?auto=format&fit=crop&w=800&q=80",
      },
    ],
  ...
  honey: {
    ...
    description:
      "Our wild honey is ethically harvested from the pristine forests of the Eastern Himalayas. Collected by tribal communities using sustainable methods, this honey offers a unique flavor profile with natural health benefits.",
    ...
    process: [
      {
        title: "Harvesting",
        description:
          "Ethically harvested by tribal communities using traditional techniques that protect the bees and their habitat.",
        image:
      ...
      },
      {
        title: "Processing",
        description:
          "Cold-extracted to preserve natural enzymes, antioxidants, and flavor compounds.",
        image:
      ...
      },
      {
        title: "Quality Testing",
        description:
          "Each batch tested for purity, moisture content, and HMF levels to ensure premium quality.",
        image:
      ...
      },
      {
        title: "Packaging",
        description:
          "Packed in glass jars to maintain purity and prevent contamination.",
        image:
          "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?auto=format&fit=crop&w=800&q=80",
      },
    ],
  ...
  coffee: {
    ...
    description:
      "Our premium shade-grown coffee beans are sourced from small farms in Coorg. These beans offer a rich, balanced flavor profile with notes of chocolate, caramel, and mild fruit undertones.",
    ...
    process: [
      {
        title: "Harvesting",
        description:
          "Hand-picked at peak ripeness to ensure optimal flavor development.",
        image:
          "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Processing",
        description:
          "Carefully washed and sun-dried to develop complex flavor profiles.",
        image:
          "https://images.unsplash.com/photo-1465379944081-7f47de8d74ac?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Sorting",
        description:
          "Meticulously sorted to remove defects and ensure consistent quality.",
        image:
          "https://images.unsplash.com/photo-1518495973542-4542c06a5843?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Packaging",
        description:
          "Vacuum-sealed with one-way valves to preserve freshness and aroma.",
        image:
          "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?auto=format&fit=crop&w=800&q=80",
      },
    ],
  ...
  annatto: {
    ...
    description:
      "Our annatto seeds are sourced from tribal communities in Northeast India. These vibrant red seeds provide natural coloring and a subtle earthy flavor, perfect for food products and traditional recipes.",
    ...
    process: [
      {
        title: "Harvesting",
        description:
          "Carefully harvested by tribal communities using sustainable methods.",
        image:
          "https://images.unsplash.com/photo-1472396961693-142e6e269027?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Processing",
        description:
          "Naturally sun-dried to preserve color compounds and flavor.",
        image:
          "https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Quality Testing",
        description:
          "Tested for bixin content and color strength to ensure consistent quality.",
        image:
          "https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?auto=format&fit=crop&w=800&q=80",
      },
      {
        title: "Packaging",
        description:
          "Packed in light-protective packaging to maintain color vibrancy.",
        image:
          "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?auto=format&fit=crop&w=800&q=80",
      },
    ],
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Journey from Farm to Package
            </h2>
            <p className="text-gray-600">
              Follow the journey of our {product.name.toLowerCase()} from
              sustainable harvesting to premium packaging, ensuring quality at
              every step.
            </p>
          </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent text-white">
                <div className="max-w-3xl mx-auto">
                  <h3 className="text-xl font-bold mb-2">
                    {product.process[currentImageIndex].title}
                  </h3>
                  <p className="text-white/90">
                    {product.process[currentImageIndex].description}
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 bg-white reveal">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600">
              We adhere to the highest quality standards and certifications to
              ensure our products meet international requirements.
            </p>
          </div>
